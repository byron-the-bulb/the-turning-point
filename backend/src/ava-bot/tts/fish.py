...
class FishAudioTTSServiceCustom(InterruptibleTTSService):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        params = params or FishAudioTTSServiceCustom.InputParams()
    ...
    async def _connect_websocket(self):
        try:
            ...
            headers = {"Authorization": f"Bearer {self._api_key}", "model": "s1"}
